...
//using namespace std;
//
//void display(int******** A, int x, int y, int z, int fourD, int fiveD, int sixD, int sevenD, int eightD) {
//	int count = 0;
//	cout << endl;
...
//}
//
//void insert(int******** A, int x, int y, int z, int fourD, int fiveD, int sixD, int sevenD, int eightD) {
//
...
//
//	int x, y, z, a, b, c, d, e;
//	cout << "Enter the x, y, z, 4D, 5D, 6D, 7D and 8D?" << endl;
//	cin >> x >> y >> z >> a >> b >> c >> d >> e;
//
...
//		}
//	}
//	insert(arr, x, y, z, a, b, c, d, e);
//	display(arr, x, y, z, a, b, c, d, e);
//
//	for (int i = 0; i < x; i++) {
//		for (int j = 0; j < y; j++) {
//			for (int k = 0; k < z; k++) {
